	...
	<main>
		<form action="includes/index_inc.php" id="form-group" method="post"><!--onsubmit="func()"-->
			...
			<div class="input-group">
				...
				<input type="number" name="contact" id="contact" placeholder="Please Enter your phone number">
				<i class="fas fa-exclamation-circle"></i>
				<i class="fas fa-check-circle"></i>
				<p>Error message</p>
			</div>
			<div class="input-group">
				...
				<textarea name="address" id="address" cols="0" rows="2" placeholder="Enter Your Address please"></textarea>
				<i class="fas fa-exclamation-circle"></i>
				<i class="fas fa-check-circle"></i>
				<p>Error message</p>
			</div>
